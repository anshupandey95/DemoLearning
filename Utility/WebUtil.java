...
public class WebUtil {
	...
	public void actionupload(String filepath, String elementvalue) throws AWTException {
		...
		test.log(Status.INFO, MarkupHelper.createLabel(elementvalue + "Picture uploaded suscessfully", ExtentColor.BLUE));
...
//						MarkupHelper.createLabel(browser + "browser launched succesfully", ExtentColor.INDIGO));
	...
	public void sendkeysNormal(WebElement we, String values, String lodetai) {
		...
		test.log(Status.INFO, MarkupHelper.createLabel(lodetai + "Keys sent suscessfully with normal click", ExtentColor.ORANGE));
	}
	...
	public void javascriptClick(WebElement ele, String Logdetai) {
		...
		test.log(Status.INFO, MarkupHelper.createLabel(Logdetai + "Clicked suscessfully using javascript", ExtentColor.PINK));
	...
	public void javaScrollToElement(WebElement element, String scrollButtonlog) {
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel("Scrolling Achieved upto" + scrollButtonlog, ExtentColor.BROWN));
...
//		Thread.sleep(1000);
//		SearchContext shadow = driver.findElement(By.cssSelector("body > app-root:nth-child(1) > ion-app:nth-child(1) > ion-split-pane:nth-child(1) > ion-router-outlet:nth-child(2) > app-profile:nth-child(2) > ion-content:nth-child(2) > div:nth-child(1) > ion-grid:nth-child(2) > ion-row:nth-child(1) > ion-col:nth-child(1) > ion-row:nth-child(1) > ion-col:nth-child(1) > ion-card:nth-child(1) > ion-card-content:nth-child(1) > ion-button:nth-child(9)")).getShadowRoot();
//		Thread.sleep(1000);
//		WebElement ele = shadow.findElement(By.cssSelector(".button-native"));
//		return ele;
